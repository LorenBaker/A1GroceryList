...
import com.lbconsulting.a1grocerylist.database.SortItemsByGroup;
 ...
 */
public class ItemsByGroupLoader extends AsyncTaskLoader<List<Item>> {

    // We hold a reference to the Loader’s data here.
    private List<Item> mSortedSelectedItems;
    private boolean mMonitorChanges;
//    private boolean mIsMappingStore;

    public ItemsByGroupLoader(Context context) {
        ...
        super(context);
//        this.mIsMappingStore = isMappingStore;
    }
    ...
    public List<Item> loadInBackground() {
        ...
        mSortedSelectedItems = Item.getSelectedItems();
        Collections.sort(mSortedSelectedItems, new SortItemsByGroup());
    ...
    public void deliverResult(List<Item> data) {
        ...
        List<Item> oldData = mSortedSelectedItems;
